...
public interface MailSender {
	...
	public static boolean sendMail(String filePath) throws AddressException, MessagingException {
		...
		String userid = PropertyReader.getValue("mailusername");
		String pwd = PropertyReader.getValue("mailpassword");
		String host = PropertyReader.getValue("mailhost");
		String port = PropertyReader.getValue("mailport");
		// Config Mail Host 
